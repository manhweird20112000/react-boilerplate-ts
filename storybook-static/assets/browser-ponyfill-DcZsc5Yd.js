import { t as e } from './chunk-BneVvdWh.js'
var t = e((e, t) => {
  var n =
...
`) === 0
      ...
      function T(e, i) {
        return new Promise(function (a, o) {
          ...
          ;((d.onload = function () {
            var e = { statusText: d.statusText, headers: S(d.getAllResponseHeaders() || ``) }
            ;(l.url.indexOf(`file://`) === 0 && (d.status < 200 || d.status > 599)
              ? (e.status = 200)
              : (e.status = d.status),
          ...
          if (
            (d.open(l.method, p(l.url), !0),
            l.credentials === `include`
              ? (d.withCredentials = !0)
              : l.credentials === `omit` && (d.withCredentials = !1),
            `responseType` in d &&
              (r.blob
                ? (d.responseType = `blob`)
            ...
            i &&
              ...
              !(i.headers instanceof u || (n.Headers && i.headers instanceof n.Headers)))
          ) {
            var m = []
      ...
      return (
        (T.polyfill = !0),
        n.fetch || ((n.fetch = T), (n.Headers = u), (n.Request = b), (n.Response = C)),
        (t.Headers = u),
        (t.Request = b),
        (t.Response = C),
        (t.fetch = T),
