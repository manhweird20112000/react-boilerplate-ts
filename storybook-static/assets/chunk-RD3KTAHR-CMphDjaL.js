...
import { R as n, t as r } from './iframe-SXVsTQNR.js'
import { a as i, c as a } from './theming-C-0qHXr1.js'
import { t as o } from './react-dom-Co8kYpFi.js'
function s(e, t) {
  typeof e == `function` ? e(t) : e != null && (e.current = t)
}
function c(...e) {
  return (t) => e.forEach((e) => s(e, t))
}
function l(...e) {
  return le.useCallback(c(...e), e)
}
function u(e) {
  return M.isValidElement(e) && e.type === ve
}
function d(e, t) {
  let n = { ...t }
  for (let r in t) {
...
function f(e, t) {
  return pe.useReducer((e, n) => t[e][n] ?? e, e)
}
function p(e) {
  let [t, n] = P.useState(),
    r = P.useRef({}),
  ...
  return (
    ...
    U(() => {
      if (t) {
        let e = (e) => {
            let n = m(r.current).includes(e.animationName)
            e.target === t && n && de.flushSync(() => s(`ANIMATION_END`))
          },
          n = (e) => {
...
function te(e, t = []) {
  ...
  function r(t, r) {
    ...
    function o(t) {
      ...
      return (0, me.jsx)(s.Provider, { value: c, children: r })
    }
    function s(n, o) {
      let s = o?.[e][a] || i,
        c = F.useContext(s)
    ...
    return ((o.displayName = t + `Provider`), [o, s])
  }
  let i = () => {
...
function x(e, t) {
  return he.useReducer((e, n) => t[e][n] ?? e, e)
}
function S(e) {
...
function w(e) {
  let t = C(e.viewport, e.content),
    n = e.scrollbar.paddingStart + e.scrollbar.paddingEnd,
    r = (e.scrollbar.size - n) * t
  return Math.max(r, 18)
}
function T(e, t, n, r = `ltr`) {
  let i = w(n),
    a = i / 2,
    o = t || a,
    s = i - o,
...
function D(e, t) {
  let n = _(e),
    r = j.useRef(0)
  return (
    j.useEffect(() => () => window.clearTimeout(r.current), []),
    j.useCallback(() => {
...
function ie(e, t) {
  ...
  let i = j.Children.only(r)
  return j.cloneElement(i, { children: typeof t == `function` ? t(i.props.children) : t })
}
async function ae(e) {
  try {
    await $.top?.navigator.clipboard.writeText(e)
  } catch {
    await $.navigator.clipboard.writeText(e)
  }
}
async function oe(e) {
  let t = Q.createElement(`TEXTAREA`),
    n = Q.activeElement
  ;((t.value = e),
...
function se() {
  return $.navigator?.clipboard ? ae : oe
}
var k,
  A,
  j,
  ...
  Xe = t(() => {
    ;((k = e(n(), 1)),
      ...
      (he = e(n(), 1)),
      (R = r()),
      (ge = a.div(({ theme: e, $flexLayout: t = !1 }) => [
        { background: e.background.content },
        t
          ? { display: `inline-flex`, marginInlineStart: `auto`, alignSelf: `flex-end` }
          : {
              position: `absolute`,
              bottom: 0,
              right: 0,
      ...
      (z.displayName = `ActionButton`),
      (_e = ({ actionItems: e, flexLayout: t = !1, ...n }) =>
        k.createElement(
          ge,
          { ...n, $flexLayout: t },
          e.map(({ title: e, className: t, onClick: n, disabled: r }, i) =>
            k.createElement(z, { key: i, className: t, onClick: n, disabled: !!r }, e)
          )
        )),
      (B = M.forwardRef((e, t) => {
        let { children: n, ...r } = e,
        ...
        return (0, N.jsx)(V, { ...r, ref: t, children: n })
      })),
      (B.displayName = `Slot`),
      (V = M.forwardRef((e, t) => {
        let { children: n, ...r } = e
        if (M.isValidElement(n)) {
          let e = ee(n)
          return M.cloneElement(n, { ...d(r, n.props), ref: t ? c(t, e) : e })
        }
        return M.Children.count(n) > 1 ? M.Children.only(null) : null
      })),
      (V.displayName = `SlotClone`),
      (ve = ({ children: e }) => (0, N.jsx)(N.Fragment, { children: e })),
      (H = [
        `a`,
        `button`,
        `div`,
      ...
      (U = globalThis?.document ? fe.useLayoutEffect : () => {}),
      (W = (e) => {
      ...
      (Ce = j.forwardRef((e, t) => {
        let { __scopeScrollArea: n, type: r = `hover`, dir: i, scrollHideDelay: a = 600, ...o } = e,
          [s, c] = j.useState(null),
          [u, d] = j.useState(null),
          [ee, f] = j.useState(null),
          [p, m] = j.useState(null),
          [h, te] = j.useState(null),
          [g, _] = j.useState(0),
          [y, b] = j.useState(0),
          [x, S] = j.useState(!1),
          [C, w] = j.useState(!1),
      ...
      (Ce.displayName = G),
      (we = `ScrollAreaViewport`),
      (Te = j.forwardRef((e, t) => {
        let { __scopeScrollArea: n, children: r, asChild: i, nonce: a, ...o } = e,
          s = K(we, n),
          c = l(t, j.useRef(null), s.onViewportChange)
...
`
            ...
            (0, R.jsx)(H.div, {
              ...
              children: ie({ asChild: i, children: r }, (e) =>
                (0, R.jsx)(`div`, {
      ...
      (Ee = j.forwardRef((e, t) => {
        ...
        return (
          ...
          i.type === `hover`
            ? (0, R.jsx)(De, { ...r, ref: t, forceMount: n })
            : i.type === `scroll`
              ? (0, R.jsx)(Oe, { ...r, ref: t, forceMount: n })
              : i.type === `auto`
                ? (0, R.jsx)(ke, { ...r, ref: t, forceMount: n })
                : i.type === `always`
                  ? (0, R.jsx)(J, { ...r, ref: t })
                  : null
        )
      ...
      (De = j.forwardRef((e, t) => {
        ...
        return (
          ...
          (0, R.jsx)(W, {
            present: n || a,
            children: (0, R.jsx)(ke, { 'data-state': a ? `visible` : `hidden`, ...r, ref: t })
          })
        )
      })),
      (Oe = j.forwardRef((e, t) => {
      ...
      (ke = j.forwardRef((e, t) => {
        ...
        return (
          ...
          (0, R.jsx)(W, {
            present: r || a,
            children: (0, R.jsx)(J, { 'data-state': a ? `visible` : `hidden`, ...i, ref: t })
          })
        )
      })),
      (J = j.forwardRef((e, t) => {
      ...
      (Ae = j.forwardRef((e, t) => {
        let { sizes: n, onSizesChange: r, ...i } = e,
          a = K(q, e.__scopeScrollArea),
          [o, s] = j.useState(),
          c = j.useRef(null),
          u = l(t, c, a.onScrollbarXChange)
        return (
          j.useEffect(() => {
          ...
          (0, R.jsx)(Pe, {
            ...
            onWheelScroll: (t, n) => {
              if (a.viewport) {
                ...
                ;(e.onWheelScroll(r), re(r, n) && t.preventDefault())
              }
            },
            onResize: () => {
              c.current &&
                ...
                r({
                  ...
                  scrollbar: {
                    ...
                    paddingStart: S(o.paddingLeft),
                    paddingEnd: S(o.paddingRight)
                  }
                })
            }
          })
              ...
              c.current &&
                ...
                r({
                  ...
                  scrollbar: {
                    ...
                    paddingStart: S(o.paddingTop),
                    paddingEnd: S(o.paddingBottom)
                  }
                })
            }
          })
      ...
      (Pe = j.forwardRef((e, t) => {
        let {
          ...
          w = D(ee, 10)
        function T(e) {
          g.current && u({ x: e.clientX - g.current.left, y: e.clientY - g.current.top })
        }
        return (
          j.useEffect(() => {
            let e = (e) => {
          ...
          (0, R.jsx)(Me, {
            ...
            hasThumb: i,
            onThumbChange: _(a),
            onThumbPointerUp: _(o),
            onThumbPositionChange: C,
            onThumbPointerDown: _(s),
            children: (0, R.jsx)(H.div, {
              ...f,
              ref: te,
      ...
      (Fe = j.forwardRef((e, t) => {
        let { forceMount: n, ...r } = e,
          i = Ne(Y, e.__scopeScrollArea)
        return (0, R.jsx)(W, {
          present: n || i.hasThumb,
          children: (0, R.jsx)(Ie, { ref: t, ...r })
        })
      })),
      (Ie = j.forwardRef((e, t) => {
        ...
        return (
          j.useEffect(() => {
            ...
            if (e) {
              let t = () => {
                ;(d(), !u.current && ((u.current = ze(e, s)), s()))
              }
              return (
                s(),
      ...
      (X = `ScrollAreaCorner`),
      (Le = j.forwardRef((e, t) => {
        let n = K(X, e.__scopeScrollArea),
          r = !!(n.scrollbarX && n.scrollbarY)
        return n.type !== `scroll` && r ? (0, R.jsx)(Re, { ...e, ref: t }) : null
      })),
      (Le.displayName = X),
      (Re = j.forwardRef((e, t) => {
      ...
      (Ue = Fe),
      (We = Le),
      (Ge = a(Be)(({ scrollbarsize: e, offset: t }) => ({
        width: `100%`,
        height: `100%`,
        overflow: `hidden`,
      ...
      (Ke = a(Ve)(({ focusable: e, theme: t }) => ({
        width: `100%`,
        height: `100%`,
        '&:focus': e ? { outline: `2px solid ${t.color.secondary}`, outlineOffset: -2 } : {}
      }))),
      (qe = a(He)(({ offset: e, horizontal: t, vertical: n }) => ({
        display: `flex`,
        userSelect: `none`,
        touchAction: `none`,
        ...
        '&[data-orientation="vertical"]': {
          ...
          paddingRight: e,
          marginTop: e,
          marginBottom: t === `true` && n === `true` ? 0 : e
        },
        '&[data-orientation="horizontal"]': {
      ...
      (Z = (0, A.forwardRef)(
        (
          ...
          A.createElement(
            Ge,
            { scrollbarsize: i, offset: r, className: o },
            A.createElement(
              Ke,
              { ref: c, style: { scrollPadding: a }, tabIndex: s ? 0 : void 0, focusable: s },
              e
            ),
            t &&
              A.createElement(
      ...
      ({ global: Ye } = __STORYBOOK_MODULE_GLOBAL__),
      ({ document: Q, window: $ } = Ye))
  })
export { Xe as i, Z as n, se as r, _e as t }
