...
- **Usage by relationship**:
  - **Inside a control** (icon + label, label + hint): `gap-2`
  - **Inside a group** (fields in a form, controls in a toolbar cluster): `gap-4`
...
- **Forms**:
  - Default: field stack `flex flex-col gap-4`
