...
import { C as c, S as l, a as u, c as d } from './theming-C-0qHXr1.js'
import { i as f, n as p, r as m, t as h } from './chunk-RD3KTAHR-CMphDjaL.js'
import { n as g, t as _ } from './chunk-242VQQM5-IE3HF7eW.js'
function v(e) {
...
function w(e) {
  var t = e.length
  if (t === 0 || t === 1) return e
  if (t === 2) return [e[0], e[1], `${e[0]}.${e[1]}`, `${e[1]}.${e[0]}`]
  if (t === 3)
    return [
      e[0],
      e[1],
...
function O(e, t) {
  ...
  return function (r) {
    return (
      (n += 1),
      r.map(function (r, i) {
        return k({ node: r, stylesheet: e, useInlineStyles: t, key: `code-segment-${n}-${i}` })
      })
    )
  }
}
function k(e) {
  ...
  if (u) {
    var f = O(n, a),
      p
    if (!a) p = C(C({}, s), {}, { className: D(s.className) })
    else {
      var m = Object.keys(n).reduce(function (e, t) {
          return (
      ...
      p = C(
        C({}, s),
        {},
        { className: D(g) || void 0, style: E(s.className, Object.assign({}, s.style, i), n) }
      )
    }
    var _ = f(t.children)
    return me.createElement(u, l({ key: o }, p), _)
  }
}
function A(e, t) {
...
function oe(e) {
  var t = e.codeString,
    n = e.codeStyle,
    r = e.containerStyle,
    i = r === void 0 ? { float: `left`, paddingRight: `10px` } : r,
    a = e.numberStyle,
    o = a === void 0 ? {} : a,
...
function L(e) {
  var t = e.children,
    ...
    d = e.wrapLongLines,
    f = e.wrapLines,
    p = f !== void 0 && f ? F({}, typeof s == `function` ? s(n) : s) : {}
  if (
    ((p.className = p.className ? [].concat(P(p.className.trim().split(/\s+/)), P(l)) : l), n && a)
  ) {
    var m = ce(r, n, i)
    t.unshift(I(n, m))
  }
  return (
    d & u && (p.style = F({ display: `flex` }, p.style)),
...
function R(e) {
  for (
    ...
    var i = e[r]
    if (i.type === `text`) n.push(L({ children: [i], className: P(new Set(t)) }))
    else if (i.children) {
      var a = t.concat(i.properties.className)
      R(i.children, a).forEach(function (e) {
        return n.push(e)
      })
    }
  }
...
`
          ...
          if (i === 0) {
            var c = g(
              u.slice(f + 1, p).concat(L({ children: [s], className: e.properties.className })),
              o
            )
            d.push(c)
          } else if (i === n.length - 1) {
            var l = u[p + 1] && u[p + 1].children && u[p + 1].children[0],
              m = { type: `text`, value: `${t}` }
            if (l) {
              var h = L({ children: [m], className: e.properties.className })
              u.splice(p + 1, 0, h)
            } else {
...
function ue(e) {
  var t = e.rows,
    ...
    r = e.useInlineStyles
  return t.map(function (e, t) {
    return k({ node: e, stylesheet: n, useInlineStyles: r, key: `code-segment-${t}` })
  })
}
function de(e) {
...
function pe(e, t) {
  return function (n) {
    var r = n.language,
      ...
      u =
        l === void 0
          ? {
              ...
              style: F(F({}, o[`code[class*="language-"]`]), o[`code[class*="language-${r}"]`])
            }
          : l,
      d = n.useInlineStyles,
      f = d === void 0 ? !0 : d,
      ...
      g = h === void 0 ? !0 : h,
      _ = n.startingLineNumber,
      v = _ === void 0 ? 1 : _,
      ee = n.lineNumberContainerStyle,
      te = n.lineNumberStyle,
      y = te === void 0 ? {} : te,
      x = n.wrapLines,
      S = n.wrapLongLines,
      C = S === void 0 ? !1 : S,
      ...
      A = k === void 0 ? `code` : k,
      ne = n.code,
      j = ne === void 0 ? (Array.isArray(i) ? i[0] : i) || `` : ne,
      M = n.astGenerator,
      N = b(n, ut)
    M ||= e
    var P = m
        ...
        : null,
      re = o.hljs || o[`pre[class*="language-"]`] || { backgroundColor: `#fff` },
      ie = de(M) ? `hljs` : `prismjs`,
      ae = f
        ? Object.assign({}, N, { style: Object.assign({}, re, c) })
        : Object.assign({}, N, {
            className: N.className ? `${ie} ${N.className}` : ie,
            style: Object.assign({}, c)
          })
    if (
      (C
        ? (u.style = F({ whiteSpace: `pre-wrap` }, u.style))
        : (u.style = F({ whiteSpace: `pre` }, u.style)),
      !M)
    )
      return B.createElement(O, ae, P, B.createElement(A, u, j))
    ;(((x === void 0 && E) || C) && (x = !0), (E ||= ue))
    var se = [{ type: `text`, value: j }],
      I = fe({ astGenerator: M, language: r, code: j, defaultCodeValue: se })
    I.language === null && (I.value = se)
    var ce = v + (j.match(/\n/g)?.length ?? 0),
      L = le(I, x, T, m, g, v, ce, y, C)
    return B.createElement(
      O,
      ae,
      B.createElement(A, u, !g && P, E({ rows: L, stylesheet: o, useInlineStyles: f }))
    )
  }
}
var z,
  ...
  ;(f(),
              ...
              for (; n < t.length; ) {
                ...
                if (s.type === `keyword` && s.content === `mutation`) {
                  ...
                  if (
                    ...
                    r(0).content === `{` &&
                    (n++, o(r(0), `property-mutation`), c.length > 0)
                  ) {
                    var d = a(/^\{$/, /^\}$/)
                    if (d === -1) continue
                    for (var f = n; f < d; f++) {
        ...
        function n(e) {
          ;(function (e) {
            ...
            for (
              ...
              e.util.type(a) === `RegExp` && (a = e.languages.javascript[i] = { pattern: a })
              var o = a.inside || {}
            ...
            var o = function (e) {
              ...
              s = function (t) {
                for (var n = [], r = 0; r < t.length; r++) {
                  ...
                  if (
                    (typeof i != `string` &&
                      (i.type === `tag` && i.content[0] && i.content[0].type === `tag`
                        ? i.content[0].content[0].content === `</`
                          ? n.length > 0 &&
                            n[n.length - 1].tagName === o(i.content[0].content[1]) &&
                            n.pop()
                          : i.content[i.content.length - 1].content === `/>` ||
                            n.push({ tagName: o(i.content[0].content[1]), openedBraces: 0 })
                        : n.length > 0 && i.type === `punctuation` && i.content === `{`
                    ...
                    var c = o(i)
                    ;(r < t.length - 1 &&
                      (typeof t[r + 1] == `string` || t[r + 1].type === `plain-text`) &&
                      ((c += o(t[r + 1])), t.splice(r + 1, 1)),
                      r > 0 &&
                        (typeof t[r - 1] == `string` || t[r - 1].type === `plain-text`) &&
                        ((c = o(t[r - 1]) + c), t.splice(r - 1, 1), r--),
                      (t[r] = new e.Token(`plain-text`, c, null, c)))
                  }
            ...
            ;((e.languages.markdown = e.languages.extend(`markup`, {})),
              ...
              e.hooks.add(`wrap`, function (t) {
                if (t.type === `code-block`) {
                  ...
                  var s = e.languages[n]
                  if (s) t.content = e.highlight(l(t.content.value), s, n)
                  else if (n && n !== `none` && e.plugins.autoloader) {
                    var c =
                      `md-` +
                      new Date().valueOf() +
                      `-` +
                      Math.floor(Math.random() * 0x2386f26fc10000)
                    ;((t.attributes.id = c),
    ...
    (ve = n({
      '../../node_modules/hastscript/node_modules/property-information/lib/util/merge.js'(e, t) {
        ...
        t.exports = i
        function i(e) {
          for (var t = e.length, i = [], a = [], o = -1, s, c; ++o < t; )
            ((s = e[o]), i.push(s.property), a.push(s.normal), (c = s.space))
          return new r(n.apply(null, i), n.apply(null, a), c)
        }
      }
    })),
    (Z = n({
    ...
    (ye = n({
      '../../node_modules/hastscript/node_modules/property-information/lib/util/defined-info.js'(
        ...
        var n = Q(),
          r = $()
        ;((t.exports = o), (o.prototype = new n()), (o.prototype.defined = !0))
        var i = [
            `boolean`,
            `booleanish`,
            `overloadedBoolean`,
        ...
        function o(e, t, o, c) {
          var l = -1,
            u
          for (s(this, `space`, c), n.call(this, e, t); ++l < a; )
            ((u = i[l]), s(this, u, (o & r[u]) === r[u]))
        }
        function s(e, t, n) {
          n && (e[t] = n)
        }
      ...
      '../../node_modules/hastscript/node_modules/property-information/lib/util/create.js'(e, t) {
        ...
        function a(e) {
          var t = e.space,
            ...
            f
          for (d in s)
            ((f = new i(d, c(o, d), s[d], t)),
              a.indexOf(d) !== -1 && (f.mustUseProperty = !0),
              (l[d] = f),
              (u[n(d)] = d),
              (u[n(f.attribute)] = d))
          return new r(l, u, t)
      ...
      '../../node_modules/hastscript/node_modules/property-information/find.js'(e, t) {
        ...
        function l(e, t) {
          var s = n(t),
            c = t,
            l = i
          return s in e.normal
            ? e.property[e.normal[s]]
            : (s.length > 4 &&
                s.slice(0, 4) === a &&
                o.test(t) &&
                (t.charAt(4) === `-` ? (c = u(t)) : (t = d(t)), (l = r)),
              new l(c, t))
        }
        function u(e) {
        ...
        function d(e) {
          ...
          return s.test(t)
            ? e
            : ((t = t.replace(c, f)), t.charAt(0) !== `-` && (t = `-` + t), a + t)
        }
        function f(e) {
          return `-` + e.toLowerCase()
        }
    ...
    (Ae = n({
      '../../node_modules/hast-util-parse-selector/index.js'(e, t) {
        ...
        var n = /[#.]/g
        function r(e, t) {
          for (var r = e || ``, i = t || `div`, a = {}, o = 0, s, c, l; o < r.length; )
            ((n.lastIndex = o),
              (l = n.exec(r)),
              (s = r.slice(o, l ? l.index : r.length)),
              s &&
                (c
                  ? c === `#`
                    ? (a.id = s)
    ...
    (Me = n({
      '../../node_modules/hastscript/node_modules/comma-separated-tokens/index.js'(e) {
        ...
        var t = `,`,
          ...
          r = ``
        function i(e) {
          for (var n = [], i = String(e || r), a = i.indexOf(t), o = 0, s = !1, c; !s; )
            (a === -1 && ((a = i.length), (s = !0)),
              (c = i.slice(o, a).trim()),
              (c || !s) && n.push(c),
              (o = a + 1),
        ...
        function a(e, i) {
          var a = i || {},
            o = a.padLeft === !1 ? r : n,
            s = a.padRight ? n : r
          return (e[e.length - 1] === r && (e = e.concat(r)), e.join(s + t + o).trim())
        }
      }
    })),
    (Ne = n({
      '../../node_modules/hastscript/factory.js'(e, t) {
        ...
        function c(e, t, r) {
          ...
          function u(e, n) {
            var r = i(e, t),
              ...
              u
            if (
              ((r.tagName = c && s.call(c, o) ? c[o] : o),
              n && l(n, r) && (a.unshift(n), (n = null)),
              n)
            )
              for (u in n) p(r.properties, u, n[u])
            return (
              d(r.children, a),
              r.tagName === `template` &&
                ((r.content = { type: `root`, children: r.children }), (r.children = [])),
              r
            )
          }
          function p(t, r, i) {
            ...
            i == null ||
              ...
              typeof l == `string` &&
                (s.spaceSeparated
                  ...
                  : s.commaSeparated
                    ? (l = o(l))
                    : s.commaOrSpaceSeparated && (l = a(o(l).join(` `)))),
              c === `style` && typeof i != `string` && (l = m(l)),
              c === `className` && t.className && (l = t.className.concat(l)),
              (t[c] = f(s, c, l)))
          }
        }
        function l(e, t) {
          return typeof e == `string` || `length` in e || u(t.tagName, e)
        }
        function u(e, t) {
          var n = t.type
        ...
        function d(e, t) {
          ...
          if (typeof t == `object` && `length` in t) {
            for (n = -1, r = t.length; ++n < r; ) d(e, t[n])
            return
          }
        ...
        function f(e, t, n) {
          var r, i, a
          if (typeof n != `object` || !(`length` in n)) return p(e, t, n)
          for (i = n.length, r = -1, a = []; ++r < i; ) a[r] = p(e, t, n[r])
          return a
        }
        function p(e, t, n) {
          var i = n
    ...
    (Pe = n({
      '../../node_modules/hastscript/html.js'(e, t) {
        var n = Oe(),
          r = Ne()(n, `div`)
        ;((r.displayName = `html`), (t.exports = r))
      }
    })),
    (Fe = n({
      ...
      '../../node_modules/refractor/node_modules/parse-entities/decode-entity.browser.js'(e, t) {
        ...
        function i(e) {
          ...
          return (
            ...
            (n.innerHTML = t),
            (i = n.textContent),
            (i.charCodeAt(i.length - 1) === r && e !== `semi`) || i === t ? !1 : i
          )
        }
      }
    })),
    (Ue = n({
      '../../node_modules/refractor/node_modules/parse-entities/index.js'(e, t) {
        ...
        var D = 1,
          ...
          M = 7,
          N = {}
        ;((N[D] = `Named character references must be terminated by a semicolon`),
          (N[O] = `Numeric character references must be terminated by a semicolon`),
          (N[k] = `Named character references cannot be empty`),
          (N[A] = `Numeric character references cannot be empty`),
          (N[ne] = `Named character references must be known`),
          (N[j] = `Numeric character references cannot be disallowed`),
          (N[M] = `Numeric character references cannot be outside the permissible Unicode range`))
        function P(e, t) {
          var n = {},
            r,
            i
        ...
        function re(e, t) {
          var i = t.additional,
            ...
            Q
          for (
            typeof i == `string` && (i = i.charCodeAt(0)), X = $(), G = re ? ye : u, R--, L++;
            ++R < L;
          )
            if ((H === p && (ue = ce[le] || 1), (H = e.charCodeAt(R)), H === g)) {
              if (
                ((W = e.charCodeAt(R + 1)),
                W === f ||
                  W === p ||
              ...
              for (
                J = R + 1,
                  ...
                  _e = E[Y],
                  Q--;
                ++Q < L && ((W = e.charCodeAt(Q)), _e(W));
              )
                ((V += l(W)), Y === S && c.call(n, V) && ((z = V), (K = n[V])))
              ;((B = e.charCodeAt(Q) === _),
                B && (Q++, (me = Y === S ? s(V) : !1), me && ((z = V), (K = me))),
                (Z = 1 + Q - J),
                (!B && !a) ||
                  (V
                    ? Y === S
                      ? (B && !K
                          ? G(ne, 1)
                          : (z !== V && ((Q = q + z.length), (Z = 1 + Q - q), (B = !1)),
                            B ||
                              ((he = z ? D : k),
                              t.attribute
                                ? ((W = e.charCodeAt(Q)),
                                  W === ee ? (G(he, Z), (K = null)) : o(W) ? (K = null) : G(he, Z))
                                : G(he, Z))),
                        (U = K))
                      : (B || G(O, Z),
                        (U = parseInt(V, T[Y])),
                ...
                U
                  ? (be(),
                    ...
                    (ve = $()),
                    ve.offset++,
                    P && P.call(oe, U, { start: X, end: ve }, e.slice(J - 1, Q)),
                    (X = ve))
                  : ((V = e.slice(J - 1, Q)), (fe += V), (ue += V.length), (R = Q - 1)))
            } else (H === 10 && (de++, le++, (ue = 0)), H === H ? ((fe += l(H)), ue++) : be())
          return pe.join(``)
          function $() {
            return { line: de, column: ue, offset: R + (I.offset || 0) }
          }
          function ye(e, t) {
            var n = $()
            ;((n.column += t), (n.offset += t), re.call(se, N[e], n, e))
          }
          function be() {
            fe &&= (pe.push(fe), d && d.call(ae, fe, { start: X, end: $() }), ``)
          }
        }
        function F(e) {
        ...
        var n = (function (e) {
          var t = /(?:^|\s)lang(?:uage)?-([\w-]+)(?=\s|$)/i,
            ...
            i = {
                  ...
                  for (var s in t)
                    if (t.hasOwnProperty(s)) {
                      ...
                      var c = t[s],
                        l = i.util.type(c)
                      l === `Object` && !a[o(c)]
                        ? ((a[o(c)] = !0), e(c, n, null, a))
                        : l === `Array` && !a[o(c)] && ((a[o(c)] = !0), e(c, n, s, a))
                    }
                }
              },
              plugins: {},
              ...
              highlightAllUnder: function (e, t, n) {
                ...
                for (var a = 0, o; (o = r.elements[a++]); )
                  i.highlightElement(o, t === !0, r.callback)
              },
              highlightElement: function (t, n, r) {
                ...
                var c = { element: t, language: a, grammar: o, code: t.textContent }
                function l(e) {
                  ;((c.highlightedCode = e),
                ...
                if (
                  (i.hooks.run(`before-sanity-check`, c),
          ...
          a.stringify = function e(t, n) {
            ...
            var a = {
              ...
              o = t.alias
            ;(o &&
              (Array.isArray(o) ? Array.prototype.push.apply(a.classes, o) : a.classes.push(o)),
              i.hooks.run(`wrap`, a))
            var s = ``
            for (var c in a.attributes)
              s += ` ` + c + `="` + (a.attributes[c] || ``).replace(/"/g, `&quot;`) + `"`
            return (
              `<` +
              a.tag +
              ` class="` +
            ...
            for (var f in n)
              if (!(!n.hasOwnProperty(f) || !n[f])) {
                ...
                for (var m = 0; m < p.length; ++m) {
                  ...
                  for (
                    var y = h.pattern || h, b = r.next, x = c;
                    b !== t.tail && !(d && x >= d.reach);
                    x += b.value.length, b = b.next
                  ) {
                    var S = b.value
                    ...
                    if (!(S instanceof a)) {
                      ...
                      if (v) {
                        ...
                        var T = w.index,
                          ...
                          D = x
                        for (D += b.value.length; T >= D; ) ((b = b.next), (D += b.value.length))
                        if (((D -= b.value.length), (x = D), b.value instanceof a)) continue
                        for (
                          var O = b;
                          O !== t.tail && (D < E || typeof O.value == `string`);
                          O = O.next
                        )
                          (C++, (D += O.value.length))
                        ;(C--, (S = e.slice(x, D)), (w.index -= x))
                      } else if (((w = o(y, 0, S, _)), !w)) continue
                      var T = w.index,
                        k = w[0],
                        A = S.slice(0, T),
                        ne = S.slice(T + k.length),
                        j = x + S.length
                      d && j > d.reach && (d.reach = j)
                      var M = b.prev
                      ;(A && ((M = l(t, M, A)), (x += A.length)), u(t, M, C))
                      var N = new a(f, g ? i.tokenize(k, g) : k, ee, k)
                      if (((b = l(t, M, N)), ne && l(t, b, ne), C > 1)) {
                        var P = { cause: f + `,` + m, reach: j }
                        ;(s(e, t, n, b.prev, x, P), d && P.reach > d.reach && (d.reach = P.reach))
                      }
                    }
                  }
                }
          ...
          if (!i.manual) {
            ...
            m === `loading` || (m === `interactive` && f && f.defer)
      ...
      '../../node_modules/refractor/core.js'(e, t) {
        ...
        function h(e, t) {
          var n = p.languages,
            ...
            o,
            s
          for (i in (t && ((r = {}), (r[e] = t)), r))
            for (a = r[i], a = typeof a == `string` ? [a] : a, o = a.length, s = -1; ++s < o; )
              n[a[s]] = n[i]
        }
        function g(e, t) {
          var n = o.highlight,
            r
          if (typeof e != `string`) throw Error('Expected `string` for `value`, got `' + e + '`')
          if (p.util.type(t) === `Object`) ((r = t), (t = null))
          else {
            if (typeof t != `string`) throw Error('Expected `string` for `name`, got `' + t + '`')
            if (d.call(p.languages, t)) r = p.languages[t]
            else throw Error('Unknown language: `' + t + '` is not registered')
          }
          return n.call(this, e, r, t)
        }
        function _(e) {
          if (typeof e != `string`) throw Error('Expected `string` for `language`, got `' + e + '`')
        ...
        function v() {
          var e = p.languages,
            t = [],
            n
          for (n in e) d.call(e, n) && typeof e[n] == `object` && t.push(n)
          return t
        }
        function ee(e, t, n) {
          var r
          return typeof e == `string`
            ...
            : p.util.type(e) === `Array`
              ...
              : ((r = {
                ...
                p.hooks.run(`wrap`, r),
                i(r.tag + `.` + r.classes.join(`.`), b(r.attributes), r.content))
        }
        function te(e, t) {
          for (var n = [], r = e.length, i = -1, a; ++i < r; )
            ((a = e[i]), a !== `` && a != null && n.push(a))
          for (i = -1, r = n.length; ++i < r; ) ((a = n[i]), (n[i] = p.Token.stringify(a, t, n)))
          return n
        }
        function y(e) {
          return e
    ...
    (Je = r(o(), 1)),
    ({ logger: Ye } = __STORYBOOK_MODULE_CLIENT_LOGGER__),
    ({ global: Xe } = __STORYBOOK_MODULE_GLOBAL__),
    (Ze = {}),
    (Qe = r(V()).default),
    ($e = r(H()).default),
    (et = r(U()).default),
    ...
    (ft = r(qe())),
    (pt = pe(ft.default, {})),
    (pt.registerLanguage = function (e, t) {
      return ft.default.register(t)
    }),
    (pt.alias = function (e, t) {
      return ft.default.alias(e, t)
    }),
    (mt = pt),
    ({ window: ht } = Xe),
    (gt = {
    ...
    Object.entries(gt).forEach(([e, t]) => {
      mt.registerLanguage(e, t)
    }),
    (_t = (0, Je.default)(2)((e) =>
      Object.entries(e.code || {}).reduce((e, [t, n]) => ({ ...e, [`* .${t}`]: n }), {})
    )),
    (vt = m()),
    (yt = d.div(
      ({ theme: e }) => ({
    ...
    (bt = ({ children: e, className: t }) =>
      z.createElement(p, { horizontal: !0, vertical: !0, focusable: !0, className: t }, e)),
    (xt = d(bt)(
      { flex: 1, flexShrink: 0, flexBasis: `fit-content`, maxWidth: `100%` },
      ({ theme: e }) => _t(e)
    )),
    (St = d.pre(({ theme: e, padded: t }) => ({
      display: `flex`,
    ...
    (Tt = ({ rows: e, stylesheet: t, useInlineStyles: n }) =>
      e.map((e, r) =>
        k({ node: wt(e), stylesheet: t, useInlineStyles: n, key: `code-segement${r}` })
      )),
    (Et = (e, t) =>
      t ? (e ? ({ rows: t, ...n }) => e({ rows: t.map((e) => wt(e)), ...n }) : Tt) : e),
    (Dt = ({
      children: e,
      language: t = `jsx`,
      copyable: n = !1,
      ...
      let [u, d] = (0, z.useState)(``)
      ;(0, z.useEffect)(() => {
        o ? o(a, e).then(d) : d(e.trim())
      }, [e, a, o])
      let [f, p] = (0, z.useState)(!1),
        m = (0, z.useCallback)(
          (e) => {
            ;(e.preventDefault(),
              vt(u)
                .then(() => {
                  ;(p(!0), ht.setTimeout(() => p(!1), 1500))
                })
                .catch(Ye.error))
          },
          [u]
      ...
      return z.createElement(
        yt,
        { bordered: r, padded: i, showLineNumbers: c, className: s },
        z.createElement(
          xt,
          null,
          z.createElement(
        ...
        n
          ? z.createElement(h, {
              actionItems: [{ title: f ? `Copied` : `Copy`, onClick: m }],
              flexLayout: !0
            })
          : null
      )
    }),
    (Dt.registerLanguage = (...e) => mt.registerLanguage(...e)),
    (Ot = Dt))
})()
export { Dt as SyntaxHighlighter, Ot as default, gt as supportedLanguages }
