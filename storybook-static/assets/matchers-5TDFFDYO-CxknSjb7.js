...
function t() {
  ...
  for (let [t, n] of Object.entries(m)) {
    for (let [t, r] of Object.entries(n))
      ((m[t] = { open: `\x1B[${r[0]}m`, close: `\x1B[${r[1]}m` }), (n[t] = m[t]), e.set(r[0], r[1]))
    Object.defineProperty(m, t, { value: n, enumerable: !1 })
  }
  return (
    Object.defineProperty(m, `codes`, { value: e, enumerable: !1 }),
    ...
    (m.color.ansi16m = p()),
    (m.bgColor.ansi = d(10)),
    (m.bgColor.ansi256 = f(10)),
    (m.bgColor.ansi16m = p(10)),
    Object.defineProperties(m, {
      ...
      hexToAnsi256: { value: (e) => m.rgbToAnsi256(...m.hexToRgb(e)), enumerable: !1 },
      ansi256ToAnsi: {
        value(e) {
          if (e < 8) return 30 + e
      ...
      rgbToAnsi: { value: (e, t, n) => m.ansi256ToAnsi(m.rgbToAnsi256(e, t, n)), enumerable: !1 },
      hexToAnsi: { value: (e) => m.ansi256ToAnsi(m.hexToAnsi256(e)), enumerable: !1 }
    }),
    m
  )
}
...
function a(e, t = 10, n = 10) {
  let r = 1e4,
    i
  try {
    i = (0, J.format)(e, { maxDepth: t, maxWidth: n, min: !0, plugins: X })
  } catch {
    i = (0, J.format)(e, { callToJSON: !1, maxDepth: t, maxWidth: n, min: !0, plugins: X })
  }
  return i.length >= r && t > 1
    ? a(e, Math.floor(t / 2), n)
    : i.length >= r && n > 1
      ? a(e, t, Math.floor(n / 2))
      : i
}
function o(e) {
  return e.replace(/\s+$/gm, (e) => _e.repeat(e.length))
}
function s(e) {
  return $(o(a(e)))
}
function c(e, t = `received`, n = `expected`, r = {}) {
  let {
      comment: i = ``,
      expectedColor: a = Q,
  ...
  return (
    ...
    c !== `` && ((f += Z(`${p}.`) + c), (p = ``)),
    s && ((f += `${Z(`${p}.`)}not`), (p = ``)),
    e.includes(`.`) ? (p += e) : ((f += Z(`${p}.`) + e), (p = ``)),
    n === `` ? (p += `()`) : ((f += Z(`${p}(`) + a(n)), u && (f += Z(`, `) + d(u)), (p = `)`)),
    i !== `` && (p += ` // ${i}`),
    p !== `` && (f += Z(p)),
    f
  )
...
function l(e) {
  if (typeof e.violations > `u`) throw Error(`No violations found in aXe results object`)
  let t = u(e.violations, e.toolOptions ? e.toolOptions.impactLevels : [])
  function n(e) {
    return e.length === 0
      ? []
      : e.map((e) =>
          e.nodes.map(
            (t) =>
              `Expected the HTML found at $('${t.target.join(`, `)}') to have no violations:
...
`)
  ...
  function a() {
    if (!i)
      return (
        c(`.toHaveNoViolations`) +
        `

${r}`
      )
  }
  return { actual: t, message: a, pass: i }
}
function u(e, t) {
  return t && t.length > 0 ? e.filter((e) => t.includes(e.impact)) : e
}
var d,
  f,
  p,
...
e(() => {
  ;((d =
    ...
    Object.keys(m.modifier),
    (h = Object.keys(m.color)),
    (g = Object.keys(m.bgColor)),
    [...h, ...g],
    (_ = t()),
    (v = (() => {
      if (!(`navigator` in globalThis)) return 0
      if (globalThis.navigator.userAgentData) {
        let e = navigator.userAgentData.brands.find(({ brand: e }) => e === `Chromium`)
        if (e && e.version > 93) return 3
      }
      return /\b(Chrome|Chromium)\//.test(globalThis.navigator.userAgent) ? 1 : 0
    })()),
    (y = v !== 0 && { level: v, hasBasic: !0, has256: v >= 2, has16m: v >= 3 }),
    (b = { stdout: y, stderr: y }),
    ({ stdout: x, stderr: S } = b),
    (C = Symbol(`GENERATOR`)),
    (w = Symbol(`STYLER`)),
    ...
    (k = (e) => {
      let t = (...e) => e.join(` `)
      return (O(t, e), Object.setPrototypeOf(t, i.prototype), t)
    }),
    Object.setPrototypeOf(i.prototype, Function.prototype))
  for (let [e, t] of Object.entries(_))
    D[e] = {
      get() {
        let n = N(this, M(t.open, t.close, this[w]), this[T])
        return (Object.defineProperty(this, e, { value: n }), n)
      }
    }
  ;((D.visible = {
    get() {
      let e = N(this, this[w], !0)
    ...
    (A = (e, t, n, ...r) =>
      e === `rgb`
        ? t === `ansi16m`
          ? _[n].ansi16m(...r)
          : t === `ansi256`
            ? _[n].ansi256(_.rgbToAnsi256(...r))
            : _[n].ansi(_.rgbToAnsi(...r))
        : e === `hex`
          ? A(`rgb`, t, n, ..._.hexToRgb(...r))
          : _[n][e](...r)))
  for (let e of [`rgb`, `hex`, `ansi256`]) {
    D[e] = {
      get() {
        let { level: t } = this
        return function (...n) {
          let r = M(A(e, E[t], `color`, ...n), _.color.close, this[w])
    ...
    D[t] = {
      get() {
        let { level: t } = this
        return function (...n) {
          let r = M(A(e, E[t], `bgColor`, ...n), _.bgColor.close, this[w])
          return N(this, r, this[T])
        }
      }
    }
  ...
  ;((j = Object.defineProperties(() => {}, {
    ...
    (M = (e, t, n) => {
      let r, i
      return (
        n === void 0 ? ((r = e), (i = t)) : ((r = n.openAll + e), (i = t + n.closeAll)),
        { open: e, close: t, openAll: r, closeAll: i, parent: n }
      )
    }),
    (N = (e, t, n) => {
      let r = (...e) => P(r, e.length === 1 ? `` + e[0] : e.join(` `))
      return (Object.setPrototypeOf(r, j), (r[C] = e), (r[w] = t), (r[T] = n), r)
    }),
    (P = (e, t) => {
      if (e.level <= 0 || !t) return e[T] ? `` : t
      let i = e[w]
      if (i === void 0) return t
      let { openAll: a, closeAll: o } = i
      if (t.includes(`\x1B`)) for (; i !== void 0; ) ((t = n(t, i.close, i.open)), (i = i.parent))
      let s = t.indexOf(`
`)
      return (s !== -1 && (t = r(t, o, a, s)), a + t + o)
    }),
    Object.defineProperties(i.prototype, D),
    (F = i()),
    i({ level: S ? S.level : 0 }),
    (I = F),
    (L = Object.create),
    ...
    (W = (e, t, n, r) => {
      if ((t && typeof t == `object`) || typeof t == `function`)
        for (let i of B(t))
          !H.call(e, i) &&
            i !== n &&
            R(e, i, { get: () => t[i], enumerable: !(r = z(t, i)) || r.enumerable })
      return e
    }),
    (ee = (e, t, n) => (
      (n = e == null ? {} : L(V(e))),
      W(t || !e || !e.__esModule ? R(n, `default`, { value: e, enumerable: !0 }) : n, e)
    )),
    (G = U({
        ...
        function a() {
          ...
          for (let [n, r] of Object.entries(t)) {
            for (let [n, i] of Object.entries(r))
              ((t[n] = { open: `\x1B[${i[0]}m`, close: `\x1B[${i[1]}m` }),
                (r[n] = t[n]),
                e.set(i[0], i[1]))
        ...
        function n(e, t, n, r, i, a, o = `: `) {
          ...
          if (!l.done) {
            ...
            for (; !l.done; ) {
              ...
              let n = a(l.value[0], t, u, r, i),
                d = a(l.value[1], t, u, r, i)
              ;((s += n + o + d),
                (l = e.next()),
        ...
        function r(e, t, n, r, i, a) {
          ...
          if (!c.done) {
            ...
            for (; !c.done; ) {
              ...
              ;((o += a(c.value, t, l, r, i)),
                (c = e.next()),
                c.done ? t.min || (o += `,`) : (o += `,${t.spacingInner}`))
            }
            o += t.spacingOuter + n
          }
          return o
    ...
    (te = U({
      'node_modules/pretty-format/build/plugins/AsymmetricMatcher.js'(e) {
        ...
        var t = K(),
          ...
          r = typeof n == `function` && n.for ? n.for(`jest.asymmetricMatcher`) : 1267621,
          i = ` `,
          a = (e, n, r, a, o, s) => {
            let c = e.toString()
            if (c === `ArrayContaining` || c === `ArrayNotContaining`)
              return ++a > n.maxDepth
                ? `[${c}]`
                : `${c + i}[${(0, t.printListItems)(e.sample, n, r, a, o, s)}]`
            if (c === `ObjectContaining` || c === `ObjectNotContaining`)
              return ++a > n.maxDepth
                ? `[${c}]`
                : `${c + i}{${(0, t.printObjectProperties)(e.sample, n, r, a, o, s)}}`
            if (
              c === `StringMatching` ||
              c === `StringNotMatching` ||
              c === `StringContaining` ||
        ...
        e.serialize = a
        var o = (e) => e && e.$$typeof === r
        ;((e.test = o), (e.default = { serialize: a, test: o }))
      }
    })),
    (ne = U({
            ...
            return ++o > i.maxDepth
              ...
              : (i.min ? `` : u + n) +
                  (r.indexOf(u) === -1
                    ...
                    : `{${(0, t.printObjectProperties)(s(e) ? Array.from(e).reduce((e, t) => ((e[t.name] = t.value), e), {}) : { ...e }, i, a, o, c, l)}}`)
          }
        ;((e.serialize = c), (e.default = { serialize: c, test: o }))
      }
    })),
    (ae = U({
...
`) !== -1 && (u = n.spacingOuter + s + u + n.spacingOuter + r),
                  (u = `{${u}}`)),
                `${n.spacingInner + r + c.prop.open + e + c.prop.close}=${c.value.open}${u}${c.value.close}`
              )
            })
            .join(``)
        }),
    ...
    (oe = U({
      'node_modules/pretty-format/build/plugins/DOMElement.js'(e) {
        ...
        var t = q(),
          ...
          l = (e) => {
            var t
            return (e == null || (t = e.constructor) == null ? void 0 : t.name) && c(e)
          }
        e.test = l
        function u(e) {
          return e.nodeType === r
      ...
      'node_modules/pretty-format/build/plugins/Immutable.js'(e) {
        ...
        var t = K(),
          ...
          h = (e, n, r, i, a, o, s) =>
            ++i > n.maxDepth
              ? f(d(s))
              : `${d(s) + p}{${(0, t.printIteratorEntries)(e.entries(), n, r, i, a, o)}}`
        function g(e) {
          let t = 0
          return {
            next() {
        ...
        var _ = (e, n, r, i, a, o) => {
            ...
            return ++i > n.maxDepth
              ? f(s)
              : `${s + p}{${(0, t.printIteratorEntries)(g(e), n, r, i, a, o)}}`
          },
          v = (e, n, r, a, o, s) => {
            let c = d(`Seq`)
            return ++a > n.maxDepth
              ? f(c)
              : e[i]
                ? `${c + p}{${e._iter || e._object ? (0, t.printIteratorEntries)(e.entries(), n, r, a, o, s) : m}}`
                : `${c + p}[${e._iter || e._array || e._collection || e._iterable ? (0, t.printIteratorValues)(e.values(), n, r, a, o, s) : m}]`
          },
          y = (e, n, r, i, a, o, s) =>
            ++i > n.maxDepth
              ? f(d(s))
              : `${d(s) + p}[${(0, t.printIteratorValues)(e.values(), n, r, i, a, o)}]`,
          b = (e, t, n, i, s, d) =>
            e[a]
              ? h(e, t, n, i, s, d, e[o] ? `OrderedMap` : `Map`)
              : e[r]
                ? y(e, t, n, i, s, d, `List`)
                : e[l]
                  ? y(e, t, n, i, s, d, e[o] ? `OrderedSet` : `Set`)
                  : e[u]
                    ? y(e, t, n, i, s, d, `Stack`)
                    : e[c]
                      ? v(e, t, n, i, s, d)
        ...
        ;((e.test = x), (e.default = { serialize: b, test: x }))
      }
    })),
    (ce = U({
    ...
    U({ 'node_modules/react-is/cjs/react-is.development.js'(e) {} }),
    (le = U({
    ...
    (de = U({
      'node_modules/pretty-format/build/plugins/ReactTestComponent.js'(e) {
        ...
        var t = q(),
          n = globalThis[`jest-symbol-do-not-touch`] || globalThis.Symbol,
          r = typeof n == `function` && n.for ? n.for(`react.test.json`) : 245830487,
          i = (e) => {
            let { props: t } = e
            return t
              ? Object.keys(t)
          ...
          a = (e, n, r, a, o, s) =>
            ++a > n.maxDepth
              ...
              : (0, t.printElement)(
                  e.type,
                  e.props ? (0, t.printProps)(i(e), e.props, n, r + n.indent, a, o, s) : ``,
                  e.children ? (0, t.printChildren)(e.children, n, r + n.indent, a, o, s) : ``,
                  n,
                  r
                )
        e.serialize = a
      ...
      U({
        'node_modules/pretty-format/build/index.js'(e) {
          ...
          var d = Object.prototype.toString,
            ...
            h = (e) => (typeof e.constructor == `function` && e.constructor.name) || `Object`,
            g = (e) => typeof window < `u` && e === window,
            _ = /^Symbol\((.*)\)(.*)$/,
            v = /\n/gi,
          ...
          function E(e, t, n, r) {
            ...
            if (i === `bigint`) return S(e)
            if (i === `string`) return r ? `"${e.replace(/"|\\/g, `\\$&`)}"` : `"${e}"`
            if (i === `function`) return C(e, t)
            if (i === `symbol`) return w(e)
            let a = d.call(e)
          ...
          function D(e, t, r, i, a, o) {
            ...
            return l === `[object Arguments]`
              ...
              : b(l)
                ? s
                  ? `[${e.constructor.name}]`
                  : `${c || (!t.printBasicPrototype && e.constructor.name === `Array`) ? `` : `${e.constructor.name} `}[${(0, n.printListItems)(e, t, r, i, a, j)}]`
                : l === `[object Map]`
                  ? s
                    ? `[Map]`
                  ...
                  : l === `[object Set]`
                    ...
                    : s || g(e)
                      ? `[${h(e)}]`
                      : `${c || (!t.printBasicPrototype && h(e) === `Object`) ? `` : `${h(e)} `}{${(0, n.printObjectProperties)(e, t, r, i, a, j)}}`
          }
          function O(e) {
...
${t}`
          ...
          function j(e, t, n, r, i, a) {
            let o = A(t.plugins, e)
            if (o !== null) return k(o, e, t, n, r, i)
            let s = E(e, t.printFunctionName, t.escapeRegex, t.escapeString)
            return s === null ? D(e, t, n, r, i, a) : s
          }
          var M = {
              comment: `gray`,
              content: `reset`,
            ...
            if (
              (Object.keys(e).forEach((e) => {
                if (!Object.prototype.hasOwnProperty.call(P, e))
                  throw Error(`pretty-format: Unknown option "${e}".`)
              }),
          ...
          var I = (e) =>
            ...
            L = () =>
              N.reduce((e, t) => ((e[t] = { close: ``, open: `` }), e), Object.create(null)),
            R = (e) => e?.printFunctionName ?? P.printFunctionName,
            z = (e) => e?.escapeRegex ?? P.escapeRegex,
            B = (e) => e?.escapeString ?? P.escapeString,
            V = (e) => ({
              callToJSON: e?.callToJSON ?? P.callToJSON,
              colors: e != null && e.highlight ? I(e) : L(),
              compareKeys: typeof e?.compareKeys == `function` ? e.compareKeys : P.compareKeys,
              escapeRegex: z(e),
              escapeString: B(e),
              indent: e != null && e.min ? `` : H(e?.indent ?? P.indent),
              maxDepth: e?.maxDepth ?? P.maxDepth,
              maxWidth: e?.maxWidth ?? P.maxWidth,
              min: e?.min ?? P.min,
              plugins: e?.plugins ?? P.plugins,
              printBasicPrototype: e?.printBasicPrototype ?? !0,
              printFunctionName: R(e),
              spacingInner:
                e != null && e.min
                  ? ` `
                  : `
...
`
          ...
          function U(e, t) {
            if (t && (F(t), t.plugins)) {
              let n = A(t.plugins, e)
              if (n !== null) return k(n, e, V(t), ``, 0, [])
            }
            let n = E(e, R(t), z(t), B(t))
            return n === null ? D(e, V(t), ``, 0, []) : n
          }
          ;((e.plugins = {
    ...
    ({
      AsymmetricMatcher: fe,
      DOMCollection: Y,
      DOMElement: pe,
      Immutable: me,
      ReactElement: he,
      ReactTestComponent: ge
    } = J.plugins),
    (X = [ge, he, pe, Y, me, fe]),
    (Z = I.dim),
    (Q = I.green),
...
export { l as toHaveNoViolations }
