try {
  ...
  <defs>
    ...
    var Xm = __STORYBOOK_CORE_EVENTS__,
      {
        ...
        SHARED_STATE_SET: Ud,
        SHARE_ISOLATE_MODE: Fd,
        SHARE_POPOVER_OPENED: Hd,
        SHARE_STORY_LINK: Gd,
    ...
    K()
    K()
    var H = { VIOLATION: 'violations', PASS: 'passes', INCOMPLETION: 'incomplete' },
      Qr = {
        'area-alt': {
          title: '<area> alt text',
      ...
      on = (e) => {
          ...
          () =>
            ft('storybook/component-test').onAllStatusChange((m, b) => {
              ...
              p?.value === 'status-value:error' &&
                ...
                c((k) => ({ ...k, status: 'component-test-error' }))
            }),
          [c, g]
        )
        let T = E(() => {
        ...
        let [R, C] = V(() => {
          ...
          Q = E((m, b, p) => {
            m.stopPropagation()
            let $ = `${b}.${p.id}`
            C((k) => new Map(k.delete($) ? k : k.set($, `${$}.1`)))
          }, []),
          ke = E(() => {
            C(new Map())
          }, []),
          ...
          ne = E(
            (m, b) => {
              let [p, $] = m.split('.'),
                { helpUrl: k, nodes: be } = d?.[p]?.find((oe) => oe.id === $) || {},
                he = k && window.open(k, '_blank', 'noopener,noreferrer')
              if (be && !he) {
                let oe =
          ...
          ma = E(async (m) => {
            let { createCopyToClipboardFunction: b } = await Promise.resolve().then(() => (K(), pt))
          ...
          o &&
            c((m) => {
              let b = { ...m.ui, highlighted: !0 },
                [p] = o.split('.') ?? []
              return (p && Object.values(H).includes(p) && (b.tab = p), { ...m, ui: b })
            })
        }, [o]),
          O(() => {
            ...
            let m = Array.from(R.values()).flatMap((p) => {
              let [$, k, be] = p.split('.')
              if ($ !== s.tab) return []
              let he = d?.[$]?.find((oe) => oe.id === k)?.nodes[Number(be) - 1]?.target
              return he ? [String(he)] : []
            })
            m.length &&
              Y($e, {
    ...
    var We = w((e, t) => {
      ...
      if (i) {
        let o = i.props.children,
          u = l.map((c) =>
            c === i ? (F.count(o) > 1 ? F.only(null) : j(o) ? o.props.children : null) : c
          )
    ...
    function dn(e) {
      ...
      let u = e + 'CollectionSlot',
        c = n.forwardRef((g, h) => {
          ...
          return n.createElement(We, { ref: C }, x)
        })
    ...
    var $n = w((e, t) => {
        ...
        return (
          ...
          y(
            ...
            y(
              ce.div,
              P({ tabIndex: x || ke === 0 ? -1 : 0, 'data-orientation': r }, d, {
                ref: S,
                ...
                onFocus: X(e.onFocus, (D) => {
                  ...
                  if (D.target === D.currentTarget && re && !x) {
                    ...
                    if ((D.currentTarget.dispatchEvent(ee), !ee.defaultPrevented)) {
                      let ne = ue().filter((W) => W.focusable),
                        fe = ne.find((W) => W.active),
                        ye = ne.find((W) => W.id === h),
                        Y = [fe, ye, ...ne].filter(Boolean).map((W) => W.ref.current)
                      Jt(Y)
                    }
                  }
                  Q.current = !1
            ...
            P(
              ...
              i,
              {
                ...
                onMouseDown: X(e.onMouseDown, (f) => {
                  !l && f.button === 0 && f.ctrlKey === !1 ? o.onValueChange(r) : f.preventDefault()
                }),
    ...
    var Mn = aa,
      ...
      Hn = I.div({ display: 'flex', flexDirection: 'column' }),
      Gn = I.div(({ theme: e }) => ({
        display: 'block',
            ...
            n.createElement(
                ...
                t.nodes.map((i, o) => {
                  ...
                  return n.createElement(
                    ...
                    n.createElement(
                      Lt,
                      { value: u, asChild: !0 },
                      n.createElement(Ut, { side: 'left' }, Ft(i))
                    )
                  )
                })
              ),
              t.nodes.map((i, o) => {
                ...
                return n.createElement(
                  ...
                  n.createElement(Ut, { side: 'right' }, Ft(i))
                )
              })
            )
          )
    ...
    function Ft(e) {
      ...
      return n.createElement(
        ...
        n.createElement(
          ...
          n.createElement(zn, { onClick: () => t(e.linkPath) })
        ),
        n.createElement(
          Mt,
                ...
                return n.createElement(
                  ...
                  n.createElement(
                    ...
                    o.impact &&
                      n.createElement(
                        z,
                        { status: a === H.PASS ? 'neutral' : Xn[o.impact] },
                        Qn[o.impact]
                      ),
                ...
                : n.createElement(
                    ...
                    r === 'initial' &&
                      n.createElement(
                        ...
                        n.createElement('p', null, 'Please wait while the addon is initializing...')
                      ),
                    r === 'manual' &&
                      n.createElement(
                        n.Fragment,
      ...
      fo = () => {
        let e = se().getSelectedPanel(),
          ...
          i =
            l === 0
              ? null
              : n.createElement(z, { compact: !0, status: e === Ee ? 'active' : 'neutral' }, l)
        return n.createElement(
          'div',
